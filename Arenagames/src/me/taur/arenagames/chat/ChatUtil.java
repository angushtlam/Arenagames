...
public class ChatUtil {
	...
	public static String basicInfoMsg(String msg) {
		return ChatColor.YELLOW + "" + ChatColor.ITALIC + msg + ChatColor.RESET;
	}
	
	public static String basicSuccessMsg(String msg) {
		return ChatColor.AQUA + "" + ChatColor.ITALIC + msg + ChatColor.RESET;
	}
	
	public static String basicErrorMsg(String msg) {
		return ChatColor.RED + "" + ChatColor.ITALIC + msg + ChatColor.RESET;
	}
	
	public static String gameInfoMsg(String msg) {
		return ChatColor.GOLD + "" + ChatColor.ITALIC + msg + ChatColor.RESET;
	}

	public static String gameSuccessMsg(String msg) {
		return ChatColor.DARK_AQUA + "" + ChatColor.ITALIC + msg + ChatColor.RESET;
	}
	
	public static String gameErrorMsg(String msg) {
		return ChatColor.DARK_RED + "" + ChatColor.ITALIC + msg + ChatColor.RESET;
	}
	
	public static String importantBroadcast(String msg) {
		return ChatColor.LIGHT_PURPLE + "" + ChatColor.BOLD + msg + ChatColor.RESET;
	}
	
	public static String cmdUsageMsg(String msg) {
		return ChatColor.YELLOW + "Usage: " + ChatColor.ITALIC + msg + ChatColor.RESET;
	}
